              ...
              <div class="row mb-2">   
                  ...
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item"><a href="<?= base_url('alumni/lowongan/status/'.$id_lowongan['id_lowongan']) ?>">Status Lamaran</a></li>
                          <li class="breadcrumb-item active">Test Seleksi</li>
                      </ol>
                  </div><!-- /.col -->
              </div><!-- /.row -->
          </div><!-- /.container-fluid -->
                      ...
                      <div class="card">
                          ...
                          <!-- form start -->
                              ...
                              <div class="card-footer">
                                <a href="<?=base_url('alumni/lowongan/status/'.$id_lowongan['id_lowongan'])?>" class="btn btn-danger">KEMBALI!</a>
