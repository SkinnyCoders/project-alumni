                            ...
                            <table id="example1" class="table table-striped">
                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                <td>Rp. <?=number_format($lowongan['gaji'], 0, '.', '.')?></td>
                                <td><?= ucwords(word_limiter($lowongan['deskripsi'], 27))?></td>
                                <td><?= DateTime::createFromFormat('Y-m-d', $lowongan['berakhir'])->format('d/m/Y') ?></td>
                                <td><a href="<?=base_url('alumni/lowongan/status/'.$lowongan['id_lowongan'])?>" class="btn btn-sm btn-success">Status</a></td>
                              </tr>
                              <?php 
                              endforeach;
                               ?>
