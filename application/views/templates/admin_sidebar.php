...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="" class="brnad-link mx-auto mt-5">
    <img src="<?=base_url('assets/images/logosmk.jpg')?>" height="50" style="margin-left: 35%; border-radius:50%; margin-top:30px;">
  </a>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if ($this->session->userdata('role') == 1) { ?>
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/perusahaan') ?>" class="nav-link <?= active('perusahaan')?>">
              <i class="nav-icon fa fa-briefcase"></i>
              <p>
                Data Perusahaan
              </p>
        ...
        <?php }elseif($this->session->userdata('role') == 5) {?>
          <li class="nav-item">
            <a href="<?= base_url('perusahaan/dashboard') ?>" class="nav-link <?= active('dashboard')?>">
              <i class="nav-icon fa fa-home"></i>
              <p>
                Dashboard
              </p>
          ...
          <li class="nav-item">
            <a href="<?= base_url('perusahaan/lowongan') ?>" class="nav-link <?= active('lowongan')?>">
              <i class="nav-icon fa fa-briefcase"></i>
              <p>
                Lowongan
              </p>
          ...
          <!-- <li class="nav-item">
            <a href="<?= base_url('perusahaan/talent_search') ?>" class="nav-link <?= active('talent_search')?>">
              <i class="nav-icon fa fa-users"></i>
              <p>
                talent search
              </p>
          ...
          <li class="nav-item">
            <a href="<?= base_url('perusahaan/managemen_test') ?>" class="nav-link <?= active('managemen_test')?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('perusahaan/users') ?>" class="nav-link <?= active('users')?>">
              <i class="nav-icon fa fa-users"></i>
              <p>
                Managemen User
              </p>
          ...
          <li class="nav-item">
            <a href="<?= base_url('perusahaan/profil') ?>" class="nav-link <?= active('profil')?>">
