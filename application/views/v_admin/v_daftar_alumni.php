                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <table class="table table-borderless">
                      ...
                      <tr id="tanggal_kerja" style="display: none;">
                        <th style="width: 20%">Tanggal Bekerja</th>
                        <td>: <span id="mulai_kerja"></span></td>
                      </tr>
                      <tr id="universitas" style="display: none;">
      ...
      success : function(res){
        ...
        switch(res.status){
          case 'Bekerja':
            ...
            $('#mulai_kerja').text(res.mulai_kerja);
          break;
