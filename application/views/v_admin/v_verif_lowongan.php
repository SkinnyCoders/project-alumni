              ...
              <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item active">Verifikasi Lowongan</li>
                      </ol>
                  </div><!-- /.col -->
              </div><!-- /.row -->
          </div><!-- /.container-fluid -->
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="card card-default ">
                          <div class="card-header">
                              <h3 class="card-title"><i class="far fa-dollar"></i> Table Verifikasi Lowongan Pekerjaan</h3>
                          </div>
                          <!-- /.card-header -->
                          <!-- form start -->
  ...
  $(document).ready(function(){
   ...
   $('.verifikasi').on('click', function(e) {
     ...
     var dataId = this.id;
     Swal.fire({
       title: 'Verifikasi Lowongan Pekerjaan',
       text: "Apakah anda yakin?, data lowongan akan ditampilkan pada sistem",
       type: "warning",
       ...
       function(isConfirm) {
         if (isConfirm.value) {
           $.ajax({
             type: "post",
             url: "<?= base_url() ?>admin/lowongan/verif/" + dataId,
             data: {
               'id_kelas': dataId,
               'status': "verifikasi"
             },
             success: function(respone) {
               window.location.href = "<?= base_url('admin/lowongan/verifikasi') ?>";
             },
   ...
   $('.cancel').on('click', function(e) {
     ...
     var dataId = this.id;
     Swal.fire({
       title: 'Tidak Verifikasi Lowongan Pekerjaan',
       text: "Apakah anda yakin?, data lowongan tidak akan tampil.",
       type: "warning",
       showCancelButton: true,
       confirmButtonColor: '#3085d6',
       cancelButtonColor: '#d33',
