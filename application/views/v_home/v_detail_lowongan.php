...
<?php
$tgl = DateTime::createFromFormat('Y-m-d H:i:s', $lowongan['create_at'])->format('d F Y');
$jam = DateTime::createFromFormat('Y-m-d H:i:s', $lowongan['create_at'])->format('H:i');
if(!empty( $lowongan['berakhir'])) {
    $tgl_berakhir = DateTime::createFromFormat('Y-m-d', $lowongan['berakhir'])->format('d F Y');
}else{
    $tgl_berakhir = '-';
}
?>
    ...
    <div class="container py-md-3">
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 about-text">
                <small class="text-muted">Di post oleh <b><?php echo ucwords($lowongan['author'])?></b> <i>pada <?=$tgl?> puluk <?=$jam?></i> </small>
                <p class="mt-3"><strong>Lowongan Berkahir pada : </strong><?=$tgl_berakhir?></p>
                <p class="mt-3"><strong>Deskripsi Pekerjaan :</strong> <br> <?php echo $lowongan['deskripsi']?></p>
                <hr class="my-3">
            </div>
        </div>
        <!-- coments section -->
            ...
            <div class="col-md-8 offset-md-2 about-text">
                <form id="formKoments">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_berita" id="id_berita" value="<?php echo $lowongan['id_lowongan']?>">
                        <input type="hidden" name="kategori" id="kategori" value="lowongan">
