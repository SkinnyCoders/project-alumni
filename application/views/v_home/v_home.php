...
<header class="py-4">
    <div class="container">
            <div id="logo">
                <h1> <a href="<?=base_url()?>"> <img src="<?=base_url('assets/images/logosmk.jpg')?>" style="width: 50px; height: 50px; border-radius:50%;"> SMK Pancasila 7 Pracimantoro</a></h1>
            </div>
        <!-- nav -->
        <nav class="d-lg-flex">
    ...
    <div class="container py-lg-5 py-sm-3">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-7 about-text">
                <h3>SMK Pancasila 7 Pracimantoro</h3>
                <p class="mt-3">SMK Pancasila 7 Pracimantoro berdiri dan menerima siswa baru sejak tahun 1984, beralamat di Godang, Pracimantoro, Pracimantoro, Wonogiri, Jawa Tengah, Kode Pos 57664. </p>
                <h2>VISI</h2>
                <p>Menghasilkan lulusan Teknisi Industri Profesional dan Kompeten di bidangnya untuk memenuhi tuntutan dunia kerja.</p>
                <h2>MISI</h2>
                <p>a.Mengembangkan iklim belajar yang berakar pada norma dan budaya bangsa. <br>
                   b.  Mengembangkan sistem pendidikan dan pelatihan yang adaptif, fleksibel, dan berwawasan global. <br>
                   c.  Mewujudkan layanan prima dalam upaya pemberdayaan sekolah dan optimal dalam menunjang program pemerintah. <br>
                   d.  Membentuk manusia pancasila sejati.
                </p> 
            </div> 
