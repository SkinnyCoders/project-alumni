             ...
             <div class="row mb-2">
                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         ...
                         <li class="breadcrumb-item"><a href="<?= base_url('perusahaan/managemen_test') ?>">Soal Seleksi</a></li>
                 ...
                 <div class="col-md-12">
                     <div class="card">
                         <div class="card-header">
                             ...
                             <a class="btn btn-sm btn-primary float-right" href="<?= base_url() ?>perusahaan/managemen_test/tambah_soal/<?= $id_seleksi ?>"><i class="fa fa-plus"></i> Tambah Soal Tes Seleksi</a>
                         </div>
                         <!-- /.card-header -->
                         <div class="card-body">
                         ...
                         <div class="modal-dialog modal-lg">
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                     <form action="<?= base_url() ?>perusahaan/managemen_test/update_soal/<?= $id_seleksi ?>" method="POST" enctype="multipart/form-data">
                                         <div class="soal">
                                             <div class="row">
                                                 <div class="col-md-8">
 ...
 <script>
     ...
     $('.update').on('click', function() {
         ...
         $.ajax({
             type: "post",
             url: "<?= base_url() ?>perusahaan/managemen_test/update_soal/<?= $id_seleksi ?>",
             data: {
                 'id': dataId
             },
             dataType: "json",
         ...
         Swal.fire({
             ...
             function(isConfirm) {
                 if (isConfirm.value) {
                     $.ajax({
                         type: "post",
                         url: "<?= base_url() ?>perusahaan/managemen_test/delete_soal/",
                         data: {
                             'id_soal': dataId
                         },
                         success: function(respone) {
                             window.location.href = "<?= base_url() ?>perusahaan/managemen_test/detail/<?= $id_seleksi ?>";
                         },
