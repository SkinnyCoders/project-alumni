                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select name="prodi[]" id="prodi_ampas" class="form-control select2" multiple="multiple" data-placeholder="Pilih Lowongan">
  ...
  <script>
    ...
    $('#jalur').on('change', function(){
      ...
      $.ajax({
        type : "POST",
        url : "<?=base_url('perusahaan/managemen_test/get_lowongan')?>",
        data : {'id_tes' : jalur},
        async : false,
        dataType : "json",
