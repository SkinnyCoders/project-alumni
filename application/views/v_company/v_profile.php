          ...
          <div class="col-md-12">
            ...
            <div class="card card-default ">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-address-card"></i> Profil Perusahaan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="" method="post" role="form" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <img class="mt-2 mb-2 img-preview" src="<?=base_url('assets/img/user/'.$data['logo'])?>" id="output">
                </div>
                <!-- /.card-body -->
      ...
      $.ajax({
          ...
          success : function(data){
            ...
            for (i = 0; i < data.rajaongkir.results.length; i++) {
                ...
                if(lokasi == data.rajaongkir.results[i].province){
                    var ampas = "selected";
                    console.log("ok");
                }else{
                    var ampas = "";
                ...
                html += '<option '+ampas+' value="' + data.rajaongkir.results[i].province + '">' + data.rajaongkir.results[i].province + '</option>'
            }
