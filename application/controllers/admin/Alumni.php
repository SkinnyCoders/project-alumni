...
class Alumni extends CI_controller
{
        ...
        if(isset($_POST['nisn']) && !empty($_POST['nisn'])){
            ...
            if(!empty($data)){
                ...
                if(!empty($data['foto'])){
                    ...
                    $foto = base_url('assets/img/user/default.png');
                }

                if(!empty($data['tanggal_lahir'])){
                    $tgl_lahir =  DateTime::createFromFormat('Y-m-d', $data['tanggal_lahir'])->format('d F Y');
                }else{
                    $tgl_lahir = 'Belum Diisi';
                }
                ...
                $alumni = [
                    ...
                    'jabatan' => !empty($data['jabatan'])?$data['jabatan']:"Belum diisi",
                    'mulai_kerja' => !empty($data['tanggal_bekerja'])?DateTime::createFromFormat('Y-m-d', $data['tanggal_bekerja'])->format('d F Y'):"Belum diisi",
                    'universitas' => !empty($data['universitas'])?$data['universitas']:"Belum diisi"
                ]; 
            }
    ...
    public function rekap(){
        ...
        $this->pdf->filename = "rekap_data_alumni.pdf";
