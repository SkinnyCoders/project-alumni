...
--
-- Host: localhost
-- Waktu pembuatan: 03 Jan 2021 pada 15.32
...
(1234567, 'test', 'user1@user.com', '$2y$10$VvV.uk0pd9dvm/zg1u6oAeCTd2ulelENlXcPwF1Dkdw9mVZE658Lm', NULL, 'L', '2020-12-10', NULL, NULL, NULL, NULL, NULL, 'default.png', NULL, NULL, 6, 'aktif'),
...
(89123456, 'Ririn A', 'ririna@gmail.com', '$2y$10$jW255/kStpXooifZplbcQ.39QFUdyrLEQgYvDylyqCv7Ip4atnJQe', NULL, 'P', NULL, NULL, NULL, NULL, NULL, NULL, 'default.png', NULL, NULL, NULL, 'aktif'),
...
INSERT INTO `company` (`id_company`, `nama`, `deskripsi`, `lokasi`, `alamat_lengkap`, `website`, `logo`, `tanggal_berdiri`, `create_at`, `status`, `bidang_usaha`) VALUES
(1, 'my startup 2', 'perusahaan dummy', 'Banten', '', 'www.my.com', '', '2020-11-25', '2020-12-19 22:02:25', 'active', 'teknologi'),
(6, 'Axis', NULL, 'DKI Jakarta', 'hhhaihdjd', NULL, NULL, '1998-11-29', '2020-12-24 14:52:29', 'active', 'Jasa Provider');

-- --------------------------------------------------------

--
-- Struktur dari tabel `company_member`
--
...
--
-- Dumping data untuk tabel `company_member`
--

INSERT INTO `company_member` (`id_member`, `id_company`, `nama`, `foto`, `email`, `password`, `alamat`, `no_telp`, `level`, `status`) VALUES
(2, 1, 'aryo', '', 'aryo@gmail.com', '$2y$10$GcOqhC1vnVmSrDlLUMjNF.4q8bI7/GKDgN1UZhzZAIIuwv/4KZL9.', 'jakarta', '08883278482', 'admin\r\n', 'active'),
(6, 6, 'Ririn', '', 'ririn1@gmail.com', '$2y$10$j1Sjr0cop9JysiqF1IuL4OagbAbFX2Qne1wrNMQiZ3.lLEQO7PfJK', '', '', 'admin', 'active');
...
--
-- Dumping data untuk tabel `hasil_tes_seleksi`
--

INSERT INTO `hasil_tes_seleksi` (`id_hasil_tes_seleksi`, `nisn`, `id_tes_seleksi`, `nilai_benar`, `nilai_akhir`, `status`) VALUES
(28, 1234567, 5, 1, 100, 'lulus'),
(29, 89123456, 5, 0, 0, 'tidak'),
(30, 89123456, 6, 1, 100, 'lulus');
...
CREATE TABLE `job_apply` (
  `id_job_apply` int(11) NOT NULL,
  `id_lowongan` int(11) NOT NULL,
  `nisn` int(50) NOT NULL,
  `resume` varchar(200) NOT NULL,
  `contact` varchar(15) NOT NULL,
  `cover_letter` varchar(300) NOT NULL,
  `status` varchar(100) NOT NULL,
  `status_berkas` varchar(30) NOT NULL DEFAULT 'pending',
...
INSERT INTO `job_apply` (`id_job_apply`, `id_lowongan`, `nisn`, `resume`, `contact`, `cover_letter`, `status`, `status_berkas`, `apply_at`) VALUES
(3, 7, 1234567, '2a0c7a044e70ddce101e86e16345ccda.pdf', '08882838923', 'ferifnerufnuerf', 'pending', 'terima', '2020-12-07 01:40:55'),
(4, 7, 89123456, 'b14130042bd12fabd66f0761e371a950.pdf', '089777562127', 'Saya akan melamar di perusahan Anda', 'pending', 'pending', '2020-12-25 14:46:13'),
(5, 7, 89123456, 'b217122cf4c8df7920dad1e89d5cd127.pdf', '089777562127', 'bjbjgui', 'pending', 'pending', '2020-12-25 14:48:28'),
(6, 8, 89123456, 'd690bf801dcdfa7619a26ace6157dc19.pdf', '089777562129', 'cobaaa', 'pending', 'pending', '2020-12-26 14:04:21');
...
--
-- Struktur dari tabel `kategori_komentar`
--
...
--
-- Dumping data untuk tabel `kategori_komentar`
--
...
(1, 0, 'test ', '2021-01-03 20:47:22', '2', 'perusahaan');
...
CREATE TABLE `lowongan` (
  ...
  `author` varchar(30) NOT NULL,
  `slug` varchar(60) NOT NULL,
  `status` enum('pending','verifikasi','cancel') NOT NULL DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lowongan` (`id_lowongan`, `posisi_pekerjaan`, `id_company`, `gaji`, `pengalaman`, `kemampuan`, `penempatan`, `deskripsi`, `thumbnail`, `berakhir`, `create_at`, `author`, `slug`, `status`) VALUES
(7, 'web developer backend', 1, '5000000', '1-3 Tahun', 'php 8', 'Bangka Belitung', 'dewdewwe', 'a529afbb89e2d83f99f510300895a69b.jpg', '2021-01-30', '2020-12-30 01:28:41', 'aryo', 'web-developer-backend-my-startup-2', 'verifikasi'),
(8, 'Pramuniaga dan Kasir', 6, '2000000', '1-3 Tahun', 'Menghitung Uang', 'DKI Jakarta', 'coba', '35d3fb097dfa8d8762878f25bca32694.jpg', '2020-12-31', '2020-12-25 14:30:14', 'Ririn', 'Pramuniaga-dan-Kasir-Axis', 'verifikasi');

-- --------------------------------------------------------

--
-- Struktur dari tabel `obrolan_pesan`
--
...
--
-- Dumping data untuk tabel `obrolan_pesan`
--
...
(6, '2020-11-24 16:53:39', 'Chrome', '::1'),
(7, '2020-12-06 21:41:40', 'Chrome', '127.0.0.1'),
(8, '2020-12-07 00:19:16', 'Chrome', '127.0.0.1'),
(9, '2020-12-10 14:38:29', 'Chrome', '::1'),
(10, '2020-12-20 21:02:10', 'Chrome', '127.0.0.1'),
(11, '2020-12-22 12:02:41', 'Chrome', '::1'),
(12, '2020-12-23 21:59:49', 'Chrome', '::1'),
(13, '2020-12-25 14:44:58', 'Chrome', '::1'),
(14, '2020-12-26 14:02:47', 'Chrome', '::1'),
(15, '2020-12-26 15:10:06', 'Chrome', '127.0.0.1'),
(16, '2020-12-28 00:03:18', 'Chrome', '127.0.0.1');
...
(51, 5, 'fnerkfnekrf', 'default.png', 'frejkfnerkn', 'nfkernfek', 'nfkrnek', 'nfjkernkf', 'a'),
(52, 6, 'tanggal berapa perusahaan ini berdiri?', 'default.png', '1', '11', '2', '12', 'a');
...
INSERT INTO `tes_seleksi` (`id_tes_seleksi`, `id_company`, `nama_tes_seleksi`, `deskripsi_tes_seleksi`, `bobot_tes`) VALUES
(5, 1, 'pyscotest', 'fnjfekfnkenfrek', 75),
(6, 5, 'Pengetahuan', 'Jawablah dengan tepat', 75);
...
--
-- Indeks untuk tabel `company_member`
--
...
ALTER TABLE `hasil_tes_seleksi`
  ...
  ADD KEY `hasil_tes_seleksi_ibfk_1` (`id_tes_seleksi`);

--
-- Indeks untuk tabel `job_apply`
--
ALTER TABLE `job_apply`
  ADD PRIMARY KEY (`id_job_apply`);
...
--
-- Indeks untuk tabel `kategori_komentar`
--
...
ALTER TABLE `konfigurasi_tes_seleksi`
  ...
  ADD KEY `konfigurasi_tes_seleksi_ibfk_1` (`id_lowongan`),
  ADD KEY `konfigurasi_tes_seleksi_ibfk_2` (`id_tes_seleksi`);
...
--
-- Indeks untuk tabel `obrolan_pesan`
--
...
--
-- AUTO_INCREMENT untuk tabel `company_member`
--
ALTER TABLE `company_member`
...
--
ALTER TABLE `hasil_tes_seleksi`
  MODIFY `id_hasil_tes_seleksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT untuk tabel `job_apply`
--
ALTER TABLE `job_apply`
  MODIFY `id_job_apply` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT untuk tabel `kategori_komentar`
--
ALTER TABLE `kategori_komentar`
...
--
ALTER TABLE `konfigurasi_tes_seleksi`
  MODIFY `id_konfigurasi_tes_seleksi` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `obrolan_pesan`
--
ALTER TABLE `obrolan_pesan`
...
--
ALTER TABLE `soal_tes_seleksi`
  MODIFY `id_soal_tes_seleksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `tes_seleksi`
  MODIFY `id_tes_seleksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Ketidakleluasaan untuk tabel `company_member`
--
ALTER TABLE `company_member`
  ADD CONSTRAINT `company_member_ibfk_1` FOREIGN KEY (`id_company`) REFERENCES `company` (`id_company`) ON DELETE CASCADE;

--
-- Ketidakleluasaan untuk tabel `hasil_tes_seleksi`
--
ALTER TABLE `hasil_tes_seleksi`
  ADD CONSTRAINT `hasil_tes_seleksi_ibfk_1` FOREIGN KEY (`id_tes_seleksi`) REFERENCES `tes_seleksi` (`id_tes_seleksi`);

--
-- Ketidakleluasaan untuk tabel `konfigurasi_tes_seleksi`
--
ALTER TABLE `konfigurasi_tes_seleksi`
  ADD CONSTRAINT `konfigurasi_tes_seleksi_ibfk_1` FOREIGN KEY (`id_lowongan`) REFERENCES `lowongan` (`id_lowongan`),
  ADD CONSTRAINT `konfigurasi_tes_seleksi_ibfk_2` FOREIGN KEY (`id_tes_seleksi`) REFERENCES `tes_seleksi` (`id_tes_seleksi`) ON DELETE CASCADE;
...
--
ALTER TABLE `lowongan`
  ADD CONSTRAINT `lowongan_ibfk_2` FOREIGN KEY (`id_company`) REFERENCES `company` (`id_company`);

--
-- Ketidakleluasaan untuk tabel `obrolan_pesan`
--
ALTER TABLE `obrolan_pesan`
